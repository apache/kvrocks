...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/zlib-subbuild/zlib-populate-prefix/src/v1.3.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/zlib-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-zlib-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-zlib-populate${i}")
