...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/lz4-subbuild/lz4-populate-prefix/src/v1.10.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/lz4-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lz4-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lz4-populate${i}")
