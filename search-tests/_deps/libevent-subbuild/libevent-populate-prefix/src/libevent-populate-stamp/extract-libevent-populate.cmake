...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/libevent-subbuild/libevent-populate-prefix/src/release-2.1.12-stable.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/libevent-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libevent-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libevent-populate${i}")
