...
func TestJson(t *testing.T) {
	...
	t.Run("JSON.NUMOP basics", func(t *testing.T) {
		...
		require.Error(t, rdb.Do(ctx, "JSON.NUMINCRBY", "a", "$", "22222222222222222222222222222222222222222222222222222").Err())
		require.Error(t, rdb.Do(ctx, "JSON.NUMMULTBY", "a", "$", "22222222222222222222222222222222222222222222222222222").Err())
