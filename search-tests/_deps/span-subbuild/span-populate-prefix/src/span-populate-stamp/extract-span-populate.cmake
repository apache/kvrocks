...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/span-subbuild/span-populate-prefix/src/v0.11.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/span-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-span-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-span-populate${i}")
