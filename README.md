...
```shell
# Centos/Redhat
sudo yum install -y snappy snappy-devel autoconf automake libtool libunwind libunwind-devel

# Ubuntu
sudo apt-get install libsnappy-dev autoconf automake libtool libunwind-dev
