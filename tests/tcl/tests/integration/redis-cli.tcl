...
start_server {tags {"cli"}} {
    ...
    test "Scan mode" {
        ...
        populate 10 key: 1
        # basic use
        assert_equal 10 [llength [split [run_cli --scan]]]
        # pattern
    ...
    test "Piping raw protocol" {
        ...
        for {set i 0} {$i < 1000} {incr i} {
            ...
            puts -nonewline $cmds_fd [formatCommand set large-key [string repeat "x" 20000]]
        }
        for {set i 0} {$i < 100} {incr i} {
            puts -nonewline $cmds_fd [formatCommand set very-large-key [string repeat "x" 512000]]
        }
        close $cmds_fd
