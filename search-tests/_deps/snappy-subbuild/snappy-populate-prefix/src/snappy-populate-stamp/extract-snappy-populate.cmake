...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/snappy-subbuild/snappy-populate-prefix/src/1.2.1.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/snappy-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-snappy-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-snappy-populate${i}")
