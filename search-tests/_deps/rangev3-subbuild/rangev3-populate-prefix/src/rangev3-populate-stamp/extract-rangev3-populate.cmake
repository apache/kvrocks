...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/rangev3-subbuild/rangev3-populate-prefix/src/0.12.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/rangev3-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-rangev3-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-rangev3-populate${i}")
