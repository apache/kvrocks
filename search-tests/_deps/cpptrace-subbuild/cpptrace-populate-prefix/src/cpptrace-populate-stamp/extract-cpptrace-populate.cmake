...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/cpptrace-subbuild/cpptrace-populate-prefix/src/v0.8.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/cpptrace-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cpptrace-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cpptrace-populate${i}")
