...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/pegtl-subbuild/pegtl-populate-prefix/src/3.2.8.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/pegtl-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-pegtl-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-pegtl-populate${i}")
