...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/tbb-subbuild/tbb-populate-prefix/src/v2022.0.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/tbb-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-tbb-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-tbb-populate${i}")
