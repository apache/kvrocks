...
Config::Config() {
  ...
  FieldWrapper fields[] = {
      ...
      {"rocksdb.max_sub_compactions", false, new IntField(&rocks_db.max_sub_compactions, 4, 0, 16)},
      ...
      {"rocksdb.cache_index_and_filter_blocks", false, new YesNoField(&rocks_db.cache_index_and_filter_blocks, true)},
