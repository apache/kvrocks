...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/xxhash-subbuild/xxhash-populate-prefix/src/v0.8.3.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/xxhash-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-xxhash-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-xxhash-populate${i}")
