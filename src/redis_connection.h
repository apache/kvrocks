...
class Connection {
 public:
  ...
  void ExecuteCommands(std::list<Redis::CommandTokens> *to_process_cmds);
  ...
  void ResetMultiExec();
  std::list<Redis::CommandTokens> *GetMultiExecCommands() { return &multi_cmds_; }
 ...
 private:
  ...
  std::list<Redis::CommandTokens> multi_cmds_;
