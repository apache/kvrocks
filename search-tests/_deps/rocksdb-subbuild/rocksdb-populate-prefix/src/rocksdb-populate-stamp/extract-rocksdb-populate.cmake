...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/rocksdb-subbuild/rocksdb-populate-prefix/src/v9.11.1.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/rocksdb-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-rocksdb-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-rocksdb-populate${i}")
