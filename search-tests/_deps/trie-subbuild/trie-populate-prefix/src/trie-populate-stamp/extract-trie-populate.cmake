...
#
get_filename_component(filename "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/trie-subbuild/trie-populate-prefix/src/906e6abd1e7063f1dacd3a6b270aa654b525eb0a.zip" ABSOLUTE)
get_filename_component(directory "/Users/vivek-w/Downloads/GSOC/kvrocks/search-tests/_deps/trie-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-trie-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-trie-populate${i}")
